...
class PedidosController:
    ...
    def create(self, body) -> Dict:
        try:
            ...
            pedido_infos = {"user_id": user_id, "email": email, "data_create": data_created, "pedido_nome":pedido_nome, "status_pedido": "Preparando...", "frete": frete, "custo_total": custo_total}

            self.__pedido_repository.registry_pedido(pedido_infos)
    ...
    def find(self, pedido_id: int) -> Dict:
        try:
            ...
            if not infos: raise Exception("Pedido not found!")
